...
router.get('/rest/api/departamentos/:iddepartamento/ciudades/',(req, res)=>{
...
router.get('/rest/api/ciudades',(req, res)=>{
	dbPool.getConnection(function(err,connection) {
...
router.get('/rest/api/ciudades/:idciudad',(req, res)=>{
	dbPool.getConnection(function(err,connection) {
        connection.query("SELECT * from hc_ciudad \
...
router.delete('/rest/api/ciudades/:idciudad',(req, res)=>{
	dbPool.getConnection(function(err,connection) {
...
router.post('/rest/api/ciudades',(req, res)=>{
	dbPool.getConnection(function(err,connection) {
        let emp = req.body;
...
router.put('/rest/api/ciudades',(req, res)=>{
	dbPool.getConnection(function(err,connection) {
        let emp = req.body;
