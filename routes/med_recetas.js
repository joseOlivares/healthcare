...
router.get('/rest/api/recetas/:idreceta/med-recetas/',verifyToken,(req, res)=>{
...
router.get('/rest/api/med-recetas',verifyToken,(req, res)=>{
	dbPool.getConnection(function(err,connection) {
...
router.get('/rest/api/med-recetas/:idmedreceta',verifyToken,(req, res)=>{
	dbPool.getConnection(function(err,connection) {
        connection.query("SELECT * from hc_med_recetas \
...
router.delete('/rest/api/med-recetas/:idmedreceta',verifyToken,(req, res)=>{
	dbPool.getConnection(function(err,connection) {
...
router.post('/rest/api/med-recetas',verifyToken,(req, res)=>{
	dbPool.getConnection(function(err,connection) {
        let emp = req.body;
...
router.put('/rest/api/med-recetas',verifyToken,(req, res)=>{
	dbPool.getConnection(function(err,connection) {
        let emp = req.body;
