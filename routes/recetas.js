...
router.get('/rest/api/diagnosticos/:iddiagnostico/recetas/',(req, res)=>{
...
router.get('/rest/api/recetas',(req, res)=>{
	dbPool.getConnection(function(err,connection) {
...
router.get('/rest/api/recetas/:idreceta',(req, res)=>{
	dbPool.getConnection(function(err,connection) {
        connection.query("SELECT * from hc_recetas \
...
router.delete('/rest/api/recetas/:idreceta',(req, res)=>{
	dbPool.getConnection(function(err,connection) {
...
router.post('/rest/api/recetas',(req, res)=>{
	dbPool.getConnection(function(err,connection) {
        let emp = req.body;
...
router.put('/rest/api/recetas',(req, res)=>{
	dbPool.getConnection(function(err,connection) {
        let emp = req.body;
